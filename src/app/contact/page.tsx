...
export default function Contact() {
  ...
  return (
    <section
      id="contact"
      ref={ref}
      className=" flex flex-col relative min-h-screen py-24  overflow-x-hidden bg-gradient-to-br from-[#0f172a] via-[#1e293b] to-[#0f172a]"
  ...
  <div className="relative z-10 max-w-[1080px] mx-auto flex flex-col gap-16">
    ...
    <footer className="py-6"> <Footer /> </footer>
     </section>
  );
}
